...
from datetime import datetime, date # Importar 'date' também para type hinting ou conversões
...
# - SQLALCHEMY_DATABASE_URI: String de conexão com o banco de dados. Pega da variável de ambiente.
#   Se a variável de ambiente não estiver definida (ex: em ambientes de teste sem .env),
#   usa um banco de dados SQLite em memória para não quebrar.
# - SQLALCHEMY_TRACK_MODIFICATIONS: Boa prática definir como False para evitar warnings.
...
#    Nota: É comum definir os modelos em models.py e importá-los aqui DEPOIS de 'db' ser inicializado,
#    para evitar importações circulares. Mas para simplificar e ter tudo num ficheiro, vamos colocá-los aqui.
...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        # Para produção, você vai usar o 'Build Command' do Render para isso.
        db.create_all()
